...
-	[Contabilidade] – RF06: Exportar relatórios e dashboards em PDF/CSV.
-	[Contabilidade] – RF07: Permitir filtro de documentos por período, status, empresa e tipo.
-	[Contabilidade] – RF08: Permitir comentários e anotações internas em documentos.
-	[Cliente] – RF09: Permitir o download e a visualização de documentos pelo cliente.
-	[Cliente] – RF10: Permitir o cadastro e atualização de e-mail pelos clientes.
-	[Cliente, Contabilidade] – RF11: Exibir um calendário com prazos de vencimento e valores totais a pagar.
-	[Contabilidade Especial] - RF12: Permitir que usuários da contabilidade (permissão especial) deletem documentos postados.
-	[Sistema] – RF13: Notificar clientes via e-mail sobre novos documentos e prazos de vencimento.
-	[Sistema] – RF14: Enviar alerta de documentos não visualizados para clientes.
-	[Sistema] – RF15: Enviar alerta de documentos não visualizados para usuários da contabilidade.
-	[Sistema] - RF16: Registrar logs de ações (visualização, envio, download).
-	[Sistema] - RF17: Detectar e notificar falhas em upload e envio de e-mail, exibindo mensagem de erro e registrando no log.
...
![Diagrama de Contêineres](diagrams/diagrama%20de%20conteiners%20do%20backend%20v3.png    )
